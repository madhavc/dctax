...
jQuery(document).ready(function() {
    ...
    ANCORA_GLOBALS['ajax_url'] = '#';
    ANCORA_GLOBALS['ajax_nonce'] = '0522b075bc';
    ANCORA_GLOBALS['ajax_nonce_editor'] = '74d053f4f2';
    ANCORA_GLOBALS['site_url'] = 'index.html';
    ANCORA_GLOBALS['vc_edit_mode'] = false;
    ANCORA_GLOBALS['theme_font'] = '';
    ANCORA_GLOBALS['theme_skin'] = 'default';
    ANCORA_GLOBALS['theme_skin_bg'] = '';
    ANCORA_GLOBALS['slider_height'] = 630;
    ANCORA_GLOBALS['system_message'] = {message: '', status: '', header: ''};
    ANCORA_GLOBALS['user_logged_in'] = false;
    ANCORA_GLOBALS['toc_menu'] = 'hide';
    ANCORA_GLOBALS['toc_menu_home'] = false;
    ANCORA_GLOBALS['toc_menu_top'] = false;
    ANCORA_GLOBALS['menu_fixed'] = true;
    ANCORA_GLOBALS['menu_relayout'] = 960;
    ANCORA_GLOBALS['menu_responsive'] = 800;
    ANCORA_GLOBALS['menu_slider'] = false;
    ANCORA_GLOBALS['demo_time'] = 0;
    ANCORA_GLOBALS['media_elements_enabled'] = true;
    ANCORA_GLOBALS['ajax_search_enabled'] = true;
    ANCORA_GLOBALS['ajax_search_min_length'] = 3;
    ANCORA_GLOBALS['ajax_search_delay'] = 200;
    ANCORA_GLOBALS['css_animation'] = true;
    ANCORA_GLOBALS['menu_animation_in'] = 'fadeIn';
    ANCORA_GLOBALS['menu_animation_out'] = 'fadeOut';
    ANCORA_GLOBALS['popup_engine'] = 'pretty';
    ANCORA_GLOBALS['popup_gallery'] = true;
    ANCORA_GLOBALS['email_mask'] = '^([a-zA-Z0-9_\\-]+\\.)*[a-zA-Z0-9_\\-]+@[a-z0-9_\\-]+(\\.[a-z0-9_\\-]+)*\\.[a-z]{2,6}$';
    ANCORA_GLOBALS['contacts_maxlength'] = 1000;
    ANCORA_GLOBALS['comments_maxlength'] = 1000;
    ANCORA_GLOBALS['remember_visitors_settings'] = false;
    ...
    ANCORA_GLOBALS['link_color'] = '#ff7839';
    ANCORA_GLOBALS['menu_color'] = '#2e2d2d';
    ANCORA_GLOBALS['user_color'] = '#FF5011';
...
function revSlidersInit(){
    "use strict";
    var setREVStartSize_1 = function () {
        "use strict";
        try {
